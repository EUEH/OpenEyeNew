...
public class FindFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void initView(View view) {
        ...
        tvAllBin = (TextView) view.findViewById(R.id.tv_all_bin);
        tvAllBin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getContext(), ConcernAuthorActivity.class);
