...
import com.eueh.openeye.find.detailhotmid.day.FindDayBean;

/**
 * Created by Even on 16/12/23.
 */

public class FindMonthAdapter extends BaseAdapter {
    private Context context;
    private FindMonthBean data;

    public FindMonthAdapter(Context context) {
        this.context = context;
    }

    public void setData(FindMonthBean data) {
        this.data = data;
