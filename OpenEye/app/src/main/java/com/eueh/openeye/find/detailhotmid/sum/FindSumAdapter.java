...
import com.eueh.openeye.find.detailhotmid.month.FindMonthBean;

/**
 * Created by Even on 16/12/23.
 */

public class FindSumAdapter extends BaseAdapter {
    private Context context;
    private FindSumBean data;

    public FindSumAdapter(Context context) {
        this.context = context;
    }

    public void setData(FindSumBean data) {
        this.data = data;
